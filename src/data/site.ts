export const siteUrl = "https://clubedosoficiaiscbmdf.com.br";

export const contact = {
  phoneDisplay: "(61) 3224-6041",
  phoneHref: "tel:+556132246041",
  whatsappNumber: "5561986257009",
  whatsappDisplay: "(61) 98625-7009",
  whatsappHref:
...
export const trustSignals = [
  "Estatuto e documentos oficiais publicados no portal.",
  "Diretoria vigente identificada por cargo, nome e posto.",
  "Endereco oficial, telefone, WhatsApp e e-mail institucionais.",
  "Fluxo de associacao com formularios e orientacoes objetivas.",
];
